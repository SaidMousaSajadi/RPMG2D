function [XMCC , YMCC , RMCC , Area , REQU , SphercityFactor] = Sphericity(BW,MICMethod,MCCMethod)
  % find boundary
  ...
  % MIC Model
  switch lower(MICMethod)
    case 'nomic'
      XMIC = S.Centroid(1) ; YMIC = S.Centroid(2) ;
    otherwise
